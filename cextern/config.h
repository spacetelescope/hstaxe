...
/* Define to 1 if you have the <gsl/gsl_spline.h> header file. */
#define HAVE_GSL_GSL_SPLINE_H 1
...
#define PACKAGE_BUGREPORT "http://hsthelp.stsci.edu"

/* Define to the full name of this package. */
#define PACKAGE_NAME "aXe"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "aXe 3.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "axe"
